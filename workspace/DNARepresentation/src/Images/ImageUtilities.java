...
public class ImageUtilities{
	...
	public void drawHex(int x, int y, int r, short[] c){
		...
		drawLine(x + (r/2),y-r, x + r, y, c); //p2 - p3
		drawLine(x + r, y,x + (r/2), y + r, c);
		drawLine(x + (r/2), y + r,x - (r/2), y + r, c);
		drawLine(x - (r/2), y + r,x -r, y, c);
		drawLine(x -r, y,x-(r/2), y-r, c);
	...
	public void drawFilledHex(int x, int y, int r, short[] c){
		
		for (int i = 0; i < r; i++){
			drawLine(x-(r/2), y-i, x + (i/2),y-i, c); // p1 - p2
			drawLine(x + (i/2),y-i, x + i, y, c); //p2 - p3
			drawLine(x + i, y,x + (i/2), y + i, c);
			drawLine(x + (i/2), y + i,x - (i/2), y + i, c);
			drawLine(x - (i/2), y + i,x -i, y, c);
			drawLine(x -i, y,x-(i/2), y-i, c);
		}
	//	image = makeNewBufferedImage(red, green, blue);
	}
